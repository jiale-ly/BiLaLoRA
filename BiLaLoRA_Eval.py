...
BASE_MODEL_PATH = 'experiment/DEA/Base/saved_model/best_s.pth'
LORA_CHECKPOINT_PATH = 'experiment/DEA/LoRA/saved_model/epoch_30_lora_adapter_finetuned.pth'

INPUT_FOLDER = 'dataset/Haze/Rea/F31'
OUTPUT_FOLDER_BASE = './outputs/Bilevel/base/F31'
OUTPUT_FOLDER_LORA = './outputs/Bilevel/lora/F31'
